...
public class StyleKit : NSObject {
    ...
    public class func drawPunkuDoorLogo(#frame: CGRect) {
        //// General Declarations
        let context = UIGraphicsGetCurrentContext()
        ...
        CGContextScaleCTM(context, symbolRect.size.width / 1535, symbolRect.size.height / 2779)

        StyleKit.drawPunkuDoor()
        CGContextRestoreGState(context)
    }
